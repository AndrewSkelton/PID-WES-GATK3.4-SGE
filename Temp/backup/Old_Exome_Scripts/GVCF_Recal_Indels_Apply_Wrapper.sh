...
#  Description : Job Submission Script - ApplyRecalibration for Indels (GVCF)               |
#-------------------------------------------------------------------------------------------#
...
cp $2/'GATK_GVCF/GVCF_indels.'* $TMPDIR
##'-----------------------------------------------------------------------------------------#

##'Add to Log
##'-----------------------------------------------------------------------------------------#
echo '' >> $3/$2'.log'
echo 'GATK Started - ApplyRecalibration (Indels GVCF): '$(date) >> $2/'GATK_GVCF/GATK_GVCF.log'
...
echo 'Running ApplyRecalibration (Indels GVCF)' >> $2/'GATK_GVCF/GATK_GVCF.log'
...
java -Xmx70g -jar \
    $GATK_ROOT/GenomeAnalysisTK.jar \
        ...
        -o $TMPDIR/'GATK_GVCF_Recal_indels.vcf' \

mv $TMPDIR/'GATK_GVCF_Recal_indels.vcf'* $2/'GATK_GVCF'
# mv $3/'GATK_Pipeline'/'GATK_GVCF.VR_indels.'* $3/'GATK_Pipeline/Metrics'
##'-----------------------------------------------------------------------------------------#
