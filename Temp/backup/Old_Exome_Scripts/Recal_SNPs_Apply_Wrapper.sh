...
#  Description : Job Submission Script - VariantRecalibrator for SNPs - Apply             |
#-------------------------------------------------------------------------------------------#
...
cp $3/'GATK_Pipeline'/$2'.VR_SNPs.recal' $TMPDIR
cp $3/'GATK_Pipeline'/$2'.VR_SNPs.tranches' $TMPDIR
##'-----------------------------------------------------------------------------------------#
...
mv $TMPDIR/$2'_Recal_SNPs.vcf'* $3/'GATK_Pipeline'
