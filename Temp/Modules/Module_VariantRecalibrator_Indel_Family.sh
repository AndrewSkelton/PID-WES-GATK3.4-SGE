...
#  Input 7     : Ped File                                                                   |
#  Input 8     : Family Analysis Output Directory                                           |
...
mkdir ${8}/GATK/Hard_Filtering
mv ${TMPDIR}/${2}_HardFiltered_Indels.vcf* ${8}/GATK/Hard_Filtering/
##'-----------------------------------------------------------------------------------------#
...
mv ${TMPDIR}/${2}'_Indels_Selected.vcf'* ${8}/GATK/
##'-----------------------------------------------------------------------------------------#
