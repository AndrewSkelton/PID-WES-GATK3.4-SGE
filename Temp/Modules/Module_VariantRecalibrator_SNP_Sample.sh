...
#  Type        : Cluster Script                                                             |
#  Description : Run the Haplotype Caller at the sample Level, Call SNPs                    |
#  Version     : 1.0                                                                        |
...
mv ${TMPDIR}/${2}_HardFiltered_SNPs.vcf* ${3}/GATK/Hard_Filtering/
##'-----------------------------------------------------------------------------------------#
...
mv ${TMPDIR}/${2}'_SNPs_Selected.vcf'* ${3}/GATK/
##'-----------------------------------------------------------------------------------------#
